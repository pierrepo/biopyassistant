    ...
    for level in levels:
        ...
        try:
            level_info = {
                ...
                "prompt_file": level.get("prompt_file"),
...
def generate_answer(
    ...
    course_level_infos : dict[str, CourseLevel]
        ...
        the prompt file for the selected student level.
    model_name : str
        The name of the OpenAI model to use for generating the answer.
    prompt_file : str
        The file name to the text file containing the prompt template.
    logger : loguru.Logger
        Logger for logging messages.
    ...
    prompt_template_content = (
        resources.files("biopyassistant.prompt_templates")
    ...
    *,
    ...
    if relevant_chunks == []:
        ...
        answer, nb_tokens_prompt, nb_tokens_answer = generate_answer(
            ...
            prompt_file=user_level_infos.prompt_file,
            logger=logger,
        )
